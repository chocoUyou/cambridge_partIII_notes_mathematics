...
\lemnum{1} Let $G$ be a finite Abelian group with order not divisible by 2 or 3 and let $f_1, f_2, f_3, f_4 : G \rightarrow \mathbb{C}$. Then
\begin{align*}
...
\cornum{2} Let $A,B$ be subsets of a finite Abelian group $G$ with order coprime to 2 and 3. Let $A$ have density $\alpha$, $B$ have density $\beta$. Suppose that $f=A-\alpha$ has the property that $\norms{f}{U^3} \leq c$. Then
\begin{align*}
...
\defi Let $G$ be a finite Abelian group, $f: G\rightarrow \mathbb{C}$, $a\in G$. Write $\partial_a f$ for the function
\begin{align*}
